...
We remove columns named `discrete_columns`, `continuous_columns`, `total_observations`, and `memory_usage` from the dataset, then we take a look at a summary of the dataset's completeness.
