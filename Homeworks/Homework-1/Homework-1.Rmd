...
df <- read.csv("https://raw.githubusercontent.com/waheeb123/Data-621/main/Homeworks/moneyball-training-data.csv")
df <- data.frame(df)
```
...
```{r echo=FALSE}
eval_data_url <- "https://raw.githubusercontent.com/waheeb123/Data-621/main/Homeworks/moneyball-evaluation-data.csv"
